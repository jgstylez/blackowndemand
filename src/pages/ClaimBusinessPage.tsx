...
const ClaimBusinessPage = () => {
  ...
  const fetchPlansAndPromotion = async () => {
    try {
      ...
      // Fetch the VIP plan ID
      const { data: vipPlan, error: vipError } = await supabase
        .from('subscription_plans')
        .select('id, price')
        .eq('name', 'VIP Plan')
        .single();
      ...
      if (vipError) {
        console.error('Error fetching VIP plan:', vipError);
      } else if (vipPlan) {
        setVipPlanId(vipPlan.id);
        
        // Create a mock promotion (in a real app, this would come from the database)
        const mockPromotion: Promotion = {
          id: 'promo-vip-special',
          name: 'VIP Special Offer',
          description: 'Get our premium VIP plan at the price of our Basic plan',
          originalPlanId: vipPlan.id,
          originalPlanName: 'VIP Plan',
          originalPrice: vipPlan.price || 99,
          promotionalPrice: 12, // Price of Basic plan
          startDate: new Date().toISOString(),
          endDate: null // No end date for now, can be set manually later
        };
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-16">
          <div className="flex items-center justify-center gap-3 mb-6">
            ...
            <h1 className="text-4xl font-bold text-white">Claim Your Business</h1>
          </div>
          <p className="text-xl text-gray-400 max-w-3xl mx-auto">
            As a BDN Legacy Member, you automatically gain visibility on this platform. Now you can take control of your business listing and unlock powerful tools to grow your presence in our directory at a special discounted price.
          </p>
        </div>
        ...
        <div className="text-center">
          ...
          <p className="text-gray-500 text-sm mt-4">
            Don't see your business? <a href="/contact" className="text-white hover:text-gray-300">Contact us</a> for assistance.
          </p>
        </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
          <div className="bg-gray-900 rounded-xl p-6">
            ...
            <p className="text-gray-400">
              Get a verified badge that builds trust with customers and shows authenticity.
            </p>
          </div>
          ...
          <div className="bg-gray-900 rounded-xl p-6">
            ...
            <h3 className="text-lg font-semibold text-white mb-2">Business Dashboard</h3>
            <p className="text-gray-400">
              Access a easy to use dashboard to manage your listing, view analytics, and update information.
            </p>
          </div>
          ...
          <div className="bg-gray-900 rounded-xl p-6">
            ...
            <p className="text-gray-400">
              Unlock additional features like enhanced listings, promotional tools, and priority placement.
            </p>
          </div>
        </div>
        ...
        <div className="hidden bg-gray-900 rounded-2xl p-8 lg:p-12 mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <h3 className="text-lg font-semibold text-white mb-2">Search & Find</h3>
              <p className="text-gray-400">
                Search for your business using your business name, email, or description.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-400">
                Verify your ownership by confirming your business email address with a verification code.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-400">
                Get instant access to your business dashboard and start managing your listing.
              </p>
            </div>
          </div>
        </div>
