...
const BusinessListingPage = () => {
  ...
  // Define steps array dynamically based on plan type
  const steps = useMemo<Step[]>(() => {
    const baseSteps: Step[] = ["payment"];
  ...
  const handlePaymentSuccess = async (paymentData: any) => {
    ...
    try {
      ...
      const { data: insertedBusinessData, error: businessError } =
        await supabase
          .from("businesses")
          .insert(businessData)
          .select()
      ...
      console.log("Business inserted successfully:", insertedBusinessData);
      ...
      navigate("/dashboard", {
        state: {
          newBusiness: true,
          businessId: insertedBusinessData.id,
          businessName: insertedBusinessData.name,
        },
      });
    } catch (error) {
  ...
  const handleNextStep = () => {
    ...
    switch (currentStep) {
      ...
      case "media":
        ...
        break;
      // No validation for premium_features, summary, or payment steps
      default:
        isValid = true;
    }
          ...
          <div className="space-y-6">
            <div className="bg-gray-800 p-4 rounded-lg mb-6">
              ...
              <p className="text-gray-400 text-sm">
                Your {planName} includes these additional features to enhance
                your business listing. All fields below are optional.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-xs text-gray-500 mt-1">
                ...
                , upload your video, then copy and paste the embed code in the
                input field above.
              </p>
            </div>
          ...
          <div className="space-y-6">
            <div className="bg-gray-800 p-4 rounded-lg mb-4">
              ...
              <p className="text-gray-400 text-sm mb-4">
                Please review your business information before proceeding to
                payment.
              </p>
            </div>
          ...
          <div className="space-y-6">
            ...
            <div>
              <button
                ...
                disabled={loading}
                className="hidden w-full bg-white hover:bg-gray-100 text-black font-medium py-3 px-4 rounded-lg transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
              >
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="bg-gray-900 rounded-xl p-8">
          <h1 className="text-2xl font-bold text-white mb-8">
            ...
            {currentStep === "summary" && "Review & Discount"}
          </h1>
