...
const InlineBusinessEdit: React.FC<InlineBusinessEditProps> = ({
  ...
  // Add better debugging and ensure form data is properly updated
  useEffect(() => {
    console.log("🔍 Business prop updated:", {
      id: business.id,
      name: business.name,
      category: business.category,
      tags: business.tags,
    ...
    try {
      ...
      if (err instanceof Error) {
        if (err.message.includes("Permission denied")) {
          errorMessage =
            "You don't have permission to edit this business. Please contact support.";
            ...
            <div className="relative">
              ...
              <Select
                ...
                value={(formData.tags || []).map((tag) => ({
                  value: tag,
                  label: BusinessTagLabels[tag] || tag,
                }))}
