              ...
              <div className="border-t border-gray-700 pt-6 mt-6">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500 mt-1">
                    Add a promo video URL from The BlackTube or other video
                    platforms
                  </p>
                </div>
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <input
                        ...
                        name="facebook"
                        value={
                          (formData.social_links as SocialLinks)?.facebook || ""
                        }
                    ...
                    <div>
                      ...
                      <input
                        ...
                        name="twitter"
                        value={
                          (formData.social_links as SocialLinks)?.twitter || ""
                        }
                        onChange={handleSocialLinkChange}
                        className="w-full px-4 py-3 bg-gray-800 border border-gray-700 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-white focus:border-transparent"
                    ...
                    <div>
                      ...
                      <input
                        ...
                        name="linkedin"
                        value={
                          (formData.social_links as SocialLinks)?.linkedin || ""
                        }
                        onChange={handleSocialLinkChange}
                        className="w-full px-4 py-3 bg-gray-800 border border-gray-700 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-white focus:border-transparent"
                    ...
                    <div>
                      ...
                      <input
                        ...
                        name="theBlackTube"
                        value={
                          (formData.social_links as SocialLinks)
                            ?.theBlackTube || ""
                        }
                        onChange={handleSocialLinkChange}
                        className="w-full px-4 py-3 bg-gray-800 border border-gray-700 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-white focus:border-transparent"
                    ...
                    <div>
                      ...
                      <input
                        ...
                        name="fanbase"
                        value={
                          (formData.social_links as SocialLinks)?.fanbase || ""
                        }
                        onChange={handleSocialLinkChange}
                        className="w-full px-4 py-3 bg-gray-800 border border-gray-700 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-white focus:border-transparent"
